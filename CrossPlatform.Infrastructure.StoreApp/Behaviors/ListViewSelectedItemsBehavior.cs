...
{
    public class ListViewSelectedItemsBehavior : DependencyObject, Microsoft.Xaml.Interactivity.IBehavior
    {
        /// <summary>
        ...
        public static readonly DependencyProperty SelectedItemsProperty =
            DependencyProperty.Register("SelectedItems", typeof(object), typeof(ListViewSelectedItemsBehavior), new PropertyMetadata(null, OnSelectedItemsChanged));
        ...
        {
            var source = (ListViewSelectedItemsBehavior)d;
        ...
        public void Attach(DependencyObject associatedObject)
        {
            if ((associatedObject != AssociatedObject) && !DesignMode.DesignModeEnabled)
            {
                ...
                if (control == null)
                {
                    throw new InvalidOperationException("Cannot attach behavior you must have ListView.");
                }
        ...
        public void Detach()
        {
            ...
            if (AssociatedObject != null)
            {
                ((IObservableVector<object>)((ListView)AssociatedObject).SelectedItems).VectorChanged -= ControlToViewModel_VectorChanged;
            }
